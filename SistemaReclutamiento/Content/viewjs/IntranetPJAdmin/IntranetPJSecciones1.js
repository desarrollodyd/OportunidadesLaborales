                    ...
                    if (index == 0) {
                        ...
                        $.each(data_seccion, function (index_, value_) {
                            ...
                            contentd += '<div class="panel panel-default">'+
                                ...
                                (index_ +1)+ '.- Seccion ID_' + value_.sec_id + ' <div class="widget-toolbar" style="margin-top: -7px;line-height: 24px;"><span id="' + value_.sec_id + '" class="label label-' + estadoClase+' label-white middle">' + estadoText+'</span></div>'+
									                '</a>'+
                                                '</h4>'+
								            '</div >'+
                                ...
                                '<div class="col-md-2 col-sm-6 col-xs-6 pull-right"><button class="btn btn-white btn-danger btn-sm btn-block btn-round btn-eliminar-seccion" data-id="' + value_.sec_id +'" data-rel="tooltip" title="Eliminar Seccion"><i class="ace-icon fa fa-trash"></i> Eliminar</button></div>'+
            ...
            callBackSuccess: function (response) {
                ...
                $.each(data, function (index, value_) {
                    ...
                    contentd += '<div class="panel panel-default">' +
                        ...
                        '<i class="ace-icon fa fa-angle-right bigger-110" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i>' +
                        (index + 1) + '.- Seccion ID_' + value_.sec_id + ' <div class="widget-toolbar" style="margin-top: -7px;line-height: 24px;"><span id="' + value_.sec_id + '" class="label label-' + estadoClase + ' label-white middle">' + estadoText + '</span></div>' +
                        '</a>' +
                        '</h4>' +
                        '</div >' +
